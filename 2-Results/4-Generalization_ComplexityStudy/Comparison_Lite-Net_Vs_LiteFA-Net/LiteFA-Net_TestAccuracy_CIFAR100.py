...
# 📄 LiteFA-Net_TestAccuracy_CIFAR100.py
# ===============================================================
# 🔗==================== CIFAR100 🔑==========================🔗
# ===============================================================
...
LiteFA_Net_mode_tag = "Ablation_cumulation_DWCONV-ECA-FNEB-FREQSPATIAL_MIXER-FREQGATECONV2D-FARC-FREQATTNFUSE"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - -   
...
# 🅐 === Define Test log file paths ===
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - 
Lite_Net_model_test_results_path         = rf"{DATA_TEST_PATH}/1-CIFAR100/1-{exp_args.Lite_Net_model}-{exp_args.LiteFA_Net_variant}/Results/Test_{LiteFA_Net_tag_path}_{exp_args.dataset_name}_{exp_args.act_name}_{exp_args.main_opt_name}_{Lite_Net_mode_tag}_Seed{exp_args.seed1}_{exp_args.seed2}.txt"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - -   
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - 
LiteFA_Net_model_test_results_path         = rf"{DATA_TEST_PATH}/1-CIFAR100/2-{exp_args.LiteFA_Net_model}-{exp_args.LiteFA_Net_variant}/Results/Test_{LiteFA_Net_tag_path}_{exp_args.dataset_name}_{exp_args.act_name}_{exp_args.main_opt_name}_{LiteFA_Net_mode_tag}_Seed{exp_args.seed1}_{exp_args.seed2}.txt"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - -   
...
# 🅐 === Define Train log file paths ===
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - 
Lite_Net_model_train_results_path         = rf"{DATA_TEST_PATH}/1-CIFAR100/1-{exp_args.Lite_Net_model}-{exp_args.LiteFA_Net_variant}/Results/Train_{LiteFA_Net_tag_path}_{exp_args.dataset_name}_{exp_args.act_name}_{exp_args.main_opt_name}_{Lite_Net_mode_tag}_Seed{exp_args.seed1}_{exp_args.seed2}.txt"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - -   
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - 
LiteFA_Net_model_train_results_path         = rf"{DATA_TEST_PATH}/1-CIFAR100/2-{exp_args.LiteFA_Net_model}-{exp_args.LiteFA_Net_variant}/Results/Train_{LiteFA_Net_tag_path}_{exp_args.dataset_name}_{exp_args.act_name}_{exp_args.main_opt_name}_{LiteFA_Net_mode_tag}_Seed{exp_args.seed1}_{exp_args.seed2}.txt"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - -   
...
def plot_imagenet100_metrics(save_dir=r'./Plots'):
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    # 🎨 === Modern, distinct, cool palette — LiteFA-Net LiteFA-Net VS Lite-Net ===
    # COLORS = {
    ...
    COLORS = {
        "Lite_Net_model":                   "#06D6A0",    # Lite_Net-S (green-cyan)
        # - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - 
        "LiteFA_Net_model":                  "#8338EC",    # LiteFA_Net-S (purple)
    }    
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    ...
    # ────────────────────────────────────────────────────────────────
    # 📦 === Save figures ===
    fig_test_acc.savefig(os.path.join(save_dir, f"3-plot1_TestAcc_vs_Epoch_Generalization_{exp_args.dataset_name}.pdf"),
                        format="pdf", bbox_inches="tight", facecolor="white", dpi=600)
    fig_test_acc.savefig(os.path.join(save_dir, f"3-plot1_TestAcc_vs_Epoch_Generalization_{exp_args.dataset_name}.svg"),
    ...
    # ────────────────────────────────────────────────────────────────
    # 📦 === Save figures ===
    fig_test_loss.savefig(os.path.join(save_dir, f"4-TestLoss_vs_Epoch_Generalization_{exp_args.dataset_name}.pdf"),
                        format="pdf", bbox_inches="tight", facecolor="white", dpi=600)
    fig_test_loss.savefig(os.path.join(save_dir, f"4-TestLoss_vs_Epoch_Generalization_{exp_args.dataset_name}.svg"),
                        format="svg", bbox_inches="tight", facecolor="white")
...
def compute_and_save_comparison():
    ...
    report = f"""
==============================================================
FINAL CIFAR-100 COMPARISON REPORT
==============================================================
...
MACs:
Lite-Net:     {Lite_macs:.4f} MMac
LiteFA-Net:   {LiteFA_macs:.4f} MMac
Absolute Δ:   {mac_abs:+.4f} MMac
