...
# 📄 LiteFA-Net_FFT-based_SOA-Models_Comparison_ImageNet100.py
######################################## 1️⃣ 2️⃣ 3️⃣ Ⓐ Ⓑ Ⓒ 🅐 🅑 🅒 🅓 ##############################
####################################################################################################
...
# ("FFC-ResNet-200",        xx.xx,  86.24,   1.47 ),
("FFC-ResNet-50",           71.70,  28.33,   0.39 ),
("ViT-B/16 (AFNO)",         56.66,  85.74,  0.92 ),
("GFNet-B",                 61.76,  40.62,   0.65 ),
]
...
# ─────────────────────────────────────────────────────────────────────────────────────────────────
# 🎨 === Modern, distinct, cool palette — LiteFA-Net Vs. FFT-Based SOA Models ===
COLORS = {
...
def plot_models_comparison(save_dir=r'./Plots'):
    ...
    # ─────────────────────────────────────────────
    MODEL2COLOR = {
        "FFC-ResNet-50":    "ffc_resnet50_model",
        # "FFC-ResNet-200":   "ffc_resnet200_model",
        "GFNet-B":          "gfnet_b_model",
        "ViT-B/16 (AFNO)":  "afno_model",
    ...
    ANNOT_OFFSET = {
        ...
        ("ALL", "FFC-ResNet-50"):   (-4.0, 2.2),
        # ("ALL", "FFC-ResNet-200"):  (-4.3, -1.5),
        ("ALL", "GFNet-B"):         (-5.0,  2.3),
        ("ALL", "ViT-B/16 (AFNO)"): (-5.8,  2.5),     
    }
    ...
    # ax.set_ylabel(r"\textbf{Top-1 Accuracy (\%)}")
    ...
    # ─────────────────────────────────────────────
    fig.savefig(
        os.path.join(save_dir, f"FFT_Capacity_ParamsX_MACsBubble_{exp_args.dataset_name}.pdf"),
        format="pdf", bbox_inches="tight", facecolor="white", dpi=600
    )
    fig.savefig(
        os.path.join(save_dir, f"FFT_Capacity_ParamsX_MACsBubble_{exp_args.dataset_name}.svg"),
