...
# ────────────────────────────────────────────────────────────────────────────────────────────────
# 📜 ==== 🔑 afnonet.py from github.com/NVlabs/AFNO-transformer/classification/afnonet.py 🔑====
# ────────────────────────────────────────────────────────────────────────────────────────────────
# ────────────────────────────────────────────────────────────────────────────────────────────────
# 📜 ==== 🔑 afnonet.py from github.com/NVlabs/AFNO-transformer/classification/afnonet.py 🔑====
# ────────────────────────────────────────────────────────────────────────────────────────────────
...
from models.afno.bfno2d import BFNO2D

from models.afno.ls import AttentionLS
from models.afno.sa import SelfAttention
from models.afno.gfn import GlobalFilter
# ────────────────────────────────────────────────────────────────────────────────────────────────
...
class AFNONet(nn.Module):
    ...
    def forward_features(self, x):
        ...
        if not args.checkpoint_activations:    
...
if args.model_name == "afno":
    ...
    model = AFNONet(
        ...
        patch_size=16,                               # 🎀  ViT-L/16-AFNO and  ViT-B/16-AFNO: 16 
        in_chans=args.input_channels, 
        num_classes=args.num_classes,
        embed_dim=args.hidden_size,                  # 🔖 default in original paper class: 768(56.6) | used from paper:384  | 🎀 ViT-L/16-AFNO: 1024 | 🎀 ViT-B/16-AFNO: 768
        depth=args.num_layers,                       # 🔖 default in original paper class: 12 | used from paper:12 | 🎀 ViT-L/16-AFNO: 24 | 🎀 ViT-B/16-AFNO: 12
    )
