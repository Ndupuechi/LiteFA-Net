...
#####-------------------------------- NOTE RECOVERY SCRIPT CIFAR-10 NOTE --------------------------------------------#####
##########################################################################################################################
######################|--------------------------------------------------------------|####################################
############################################# CIFAR-10 ###################################################################
######################|--------------------------------------------------------------|####################################
...
MAIN_SCRIPT = os.path.join(SCRIPT_DIR, "main_cifar10.py")
...
# ─────────────────────────────────────────────────────────────────────────────────────────────────
# ⭐⭐ === Reset globals before running main_cifar10.py ===
# ─────────────────────────────────────────────────────────────────────────────────────────────────
def reset_globals_for_clean_run():
    """
    Clears all global variables except essential ones,
    so main_cifar10.py initializes train_loss_history, etc.
    """
    keep = {
...
def resume_training_loop():
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    # 🟢 === Pass --resume to main_cifar10.py 📦 ===
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    sys.argv = ["main_cifar10.py", "--resume"]
